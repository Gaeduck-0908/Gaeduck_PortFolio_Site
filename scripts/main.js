...
async function getInputValue(){
  ...
  if(value === "all" || value === "2"){
    ...
    trueValue(value);
    createText("이름 : 김태한")
    createText("(현) 경력 9개월 차 IT 재직자로 개발자를 거쳐 보안인 으로 재직중이며 <br>여러 활동을 경험하며 실력을 늘려가고 있습니다. <br>주로 <span class='blue'>Reverse Engineering</span>과 <span class='blue'>Forensic</span> 을 자주하며 <br><span class = 'blue'>Python</span> 개발과 <span class = 'blue'>Rust</span> 개발을 좋아합니다 :)")
